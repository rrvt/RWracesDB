...
String ext;
  ...
  dbTables.load(theApp.databasePath);   display(NotePadSrc);
  }
...
MemberRpts rpt(ExcelDspType);
  ...
  setFileSaveAttr(_T("BadgesByCallSign"), _T("txt"));   rpt.badgesCS();  display(NotePadSrc);
  }
...
MemberRpts rpt(ExcelDspType);
  ...
  setFileSaveAttr(_T("BadgesByDate"), _T("txt"));   rpt.badgesDT();  display(NotePadSrc);
  }
...
MemberRpts rpt(ExcelDspType);
  ...
  setFileSaveAttr(_T("FormerByName"), _T("txt"));   rpt.formerNm();  display(NotePadSrc);
  }
...
MemberRpts rpt(ExcelDspType);
  ...
  setFileSaveAttr(_T("FormerByCallSign"), _T("txt"));   rpt.formerCS();  display(NotePadSrc);
  }
...
StatusUpdate stsUpdt;
  ...
  dataSource = StsUpdtSrc;   stsUpdt.store();   theApp.announceFinish();
